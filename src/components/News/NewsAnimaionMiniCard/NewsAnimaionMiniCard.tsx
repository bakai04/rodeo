...
import css from './NewsAnimaionMiniCard.module.scss'
...
const NewsAnimaionMiniCard = ({it}:IProps) => {
    ...
    return (
        <motion.div className={css.wrapper} initial="offscreen"
            ...
            <motion.img variants={imgVariants} src={it?.image_url} className={css.bg} alt="" />
        </motion.div>
    );
};

export default NewsAnimaionMiniCard;